 ...
 * </p>
 */
public class LinkIdentityResponseVO {
     ...
     * @param createdAt
     */
    public LinkIdentityResponseVO(Optional<Integer> id, Optional<Integer> userId, Optional<String> ethereumAddress, Optional<Integer> linkingCode, Optional<String> updatedAt,
            String createdAt) {
        super();
        this.id = id;
        this.userId = userId;
