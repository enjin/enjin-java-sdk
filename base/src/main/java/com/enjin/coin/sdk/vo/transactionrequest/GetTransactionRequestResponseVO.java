...
public abstract class GetTransactionRequestResponseVO {
	...
	public String toString() {
		return "GetTransactionRequestResponseVO [txrId=" + getTxrId().orElse(null) + ", identityMap="
				+ getIdentityMap().orElse(null) + ", recipientMap=" + getRecipientMap().orElse(null) + ", type="
				+ getType().orElse(null) + ", icon=" + getIcon().orElse(null) + ", title=" + getTitle().orElse(null)
				+ ", valueMap=" + getValueMap().orElse(null) + ", state=" + getState().orElse(null) + "]";
	}
