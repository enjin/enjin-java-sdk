...
public enum EventType {
    ...
    PLAYER_CREATED("EnjinCloud\\Events\\IdentityCreated", "project", "player"),
    PLAYER_DELETED("EnjinCloud\\Events\\IdentityDeleted", "project", "player"),
    PLAYER_LINKED("EnjinCloud\\Events\\IdentityLinked", "project", "player", "wallet"),
    PLAYER_UNLINKED("EnjinCloud\\Events\\IdentityUnlinked", "project", "player", "wallet"),
    PLAYER_UPDATED("EnjinCloud\\Events\\IdentityUpdated", "project", "player"),
    ...
    TRADE_COMPLETED("EnjinCloud\\Events\\TradeCompleted", "project", "asset", "wallet"),
    TRADE_CREATED("EnjinCloud\\Events\\TradeCreated", "project", "asset", "wallet"),
