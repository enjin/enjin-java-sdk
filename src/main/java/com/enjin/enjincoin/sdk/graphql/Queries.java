...
public class Queries {
    ...
    // Users
    public static final String CREATE_USER = "mutation createUser {\n" +
            "    CreateEnjinUser(%s) {\n" +
            "        id,\n" +
            "        name,\n" +
            "        email,\n" +
            ...
            "    }\n" +
            "}";
    public static final String GET_ALL_USERS = "query getAllUsers {\n" +
            "    EnjinUsers {\n" +
            "        id,\n" +
            "        name,\n" +
            "        email,\n" +
            ...
            "    }\n" +
            "}";
    public static final String GET_USERS = "query getUsers {\n" +
            "    EnjinUsers(%s) {\n" +
            "        id,\n" +
            "        name,\n" +
            "        email,\n" +
            ...
            "    }\n" +
            "}";
    public static final String LOGIN_USER = "query login {\n" +
            "    EnjinOauth(%s) {\n" +
            "        id,\n" +
            "        name,\n" +
            "        email,\n" +
