...
public class Fields {
    ...
    public static final GraphQLTemplateField SIGNED_BACKUP_TRANSACTION = GraphQLTemplateField.of("signed_backup_transaction");
    public static final GraphQLTemplateField SIGNED_CANCEL_TRANSACTION = GraphQLTemplateField.of("signed_cancel_transaction");
